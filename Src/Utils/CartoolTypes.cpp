...
const FilterPresetSpec  FilterPresets[ NumFilterTypes ] =
            ...
            {   FilterTypeSegmentWhite,         "White Matter Extraction",              InfixWhite                  },
            {   FilterTypeSegmentTissues,       "Segment CSF/Grey/White",               InfixTissues                },
            {   FilterTypeSkullStripping,       "Skull-Stripping",                      InfixBrain                  },
            {   FilterTypeBrainstemRemoval,     "Brainstem Removal",                    "NoBrainstem"               },
