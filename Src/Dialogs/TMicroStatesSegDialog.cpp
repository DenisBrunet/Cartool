...
const SegPresetSpec SegPresets[ NumSegPresetParams ] =
            ...
            { SegPresetRisScalSpontKMeans,              "ESI / Rest. States / Individuals    / K-Means (recommended)",                    100, 1, 12, -100, 0,                        (TypeClusteringFlags) ( SegPresetRSIndiv  | SegPresetKMeans | SegPresetGfpPeaksOnly | SegPresetSpatialFilterOff | SegPresetPositiveData | SegPresetAccountPolarity | SegPresetNoRef | SegPresetZScoreOn   | SegPresetEnvelopeOff ),     (TypePostProcFlags) ( SegPresetSequentializeOff | SegPresetSmoothingOff | SegPresetRejectSmallOff | SegPresetMergeCorrOff ) },
            { SegPresetRisScalSpontKMeansAll,           "ESI / Rest. States / Individuals    / K-Means on All Data",                      100, 1, 12, -100, SmoothingDefaultHalfSize, (TypeClusteringFlags) ( SegPresetRSIndiv  | SegPresetKMeans | SegPresetAllData      | SegPresetSpatialFilterOff | SegPresetPositiveData | SegPresetAccountPolarity | SegPresetNoRef | SegPresetZScoreOn   | SegPresetEnvelopeOff ),     (TypePostProcFlags) ( SegPresetSequentializeOff | SegPresetSmoothingOff | SegPresetRejectSmallOff | SegPresetMergeCorrOff ) },
            { SegPresetRisScalCollectionKMeans,         "ESI / Rest. States / Grand Clust. / K-Means",                                    200, 1, 15, -100, 0,                        (TypeClusteringFlags) ( SegPresetRSGroup  | SegPresetKMeans | SegPresetAllData      | SegPresetSpatialFilterOff | SegPresetPositiveData | SegPresetAccountPolarity | SegPresetNoRef | SegPresetZScoreOff  | SegPresetEnvelopeOff ),     (TypePostProcFlags) ( SegPresetSequentializeOff | SegPresetSmoothingOff | SegPresetRejectSmallOff | SegPresetMergeCorrOff ) },
