...
const FitPresetSpec FitPresets[ NumFitPresets ] =
            ...
            { FitPresetEegSurfaceSpontTemplates,        "EEG / Surface / Collection of Spontaneous Templates",                50, 0,                        (TypeClusteringFlags) ( SegPresetRSIndiv  | SegPresetSignedData   | SegPresetIgnorePolarity  | SegPresetAveRef | SegPresetSpatialFilterOff | SegPresetZScoreOff | SegPresetGfpNormOff | SegPresetEnvelopeOff ),    (TypePostProcFlags) ( SegPresetSmoothingOff | SegPresetRejectSmallOff | SegPresetVariablesNoTime )  },
            ...
            { FitPresetEegIntraSpontTemplates,          "EEG / Intra-Cranial / Collection of Spontaneous Templates",          50, 0,                        (TypeClusteringFlags) ( SegPresetRSIndiv  | SegPresetSignedData   | SegPresetIgnorePolarity  | SegPresetNoRef  | SegPresetSpatialFilterOff | SegPresetZScoreOff | SegPresetGfpNormOff | SegPresetEnvelopeOff ),    (TypePostProcFlags) ( SegPresetSmoothingOff | SegPresetRejectSmallOff | SegPresetVariablesNoTime )  },
            ...
            { FitPresetMegSurfaceSpontTemplates,        "MEG / Collection of Spontaneous Templates",                          50, 0,                        (TypeClusteringFlags) ( SegPresetRSIndiv  | SegPresetPositiveData | SegPresetAccountPolarity | SegPresetNoRef  | SegPresetSpatialFilterOff | SegPresetZScoreOff | SegPresetGfpNormOff | SegPresetEnvelopeOff ),    (TypePostProcFlags) ( SegPresetSmoothingOff | SegPresetRejectSmallOff | SegPresetVariablesNoTime )  },
            ...
            { FitPresetRisScalSpont,                    "ESI / Spontaneous EEG",                                            -100, SmoothingDefaultHalfSize, (TypeClusteringFlags) ( SegPresetRSIndiv  | SegPresetPositiveData | SegPresetAccountPolarity | SegPresetNoRef  | SegPresetSpatialFilterOff | SegPresetZScoreOn  | SegPresetGfpNormOff | SegPresetEnvelopeOff ),    (TypePostProcFlags) ( SegPresetSmoothingOn  | SegPresetRejectSmallOff | SegPresetVariablesCyclic )  },
            { FitPresetRisScalSpontGfpPeaks,            "ESI / Spontaneous EEG GFP Peaks",                                  -100, 1,                        (TypeClusteringFlags) ( SegPresetRSIndiv  | SegPresetPositiveData | SegPresetAccountPolarity | SegPresetNoRef  | SegPresetSpatialFilterOff | SegPresetZScoreOn  | SegPresetGfpNormOff | SegPresetEnvelopeOff ),    (TypePostProcFlags) ( SegPresetSmoothingOn  | SegPresetRejectSmallOff | SegPresetVariablesCyclic )  },
            { FitPresetRisScalSpontTemplates,           "ESI / Collection of Spontaneous Templates",                        -100, 0,                        (TypeClusteringFlags) ( SegPresetRSIndiv  | SegPresetPositiveData | SegPresetAccountPolarity | SegPresetNoRef  | SegPresetSpatialFilterOff | SegPresetZScoreOff | SegPresetGfpNormOff | SegPresetEnvelopeOff ),    (TypePostProcFlags) ( SegPresetSmoothingOff | SegPresetRejectSmallOff | SegPresetVariablesNoTime )  },
            };
